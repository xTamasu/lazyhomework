...
<html lang="en">
  <head>
    ...
    <body class="text-center" background="img/loginbg.png" width="200">
      <form class="form-signin">
        <img class="mb-4" src="img/lazyHomework_logo_dunkel.png" alt="" width="300">
        ...
        <label for="inputPasswordVerify" class="sr-only">Passwort bestätigen</label>
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit" onclick="window.location.href='index.php'">Doch lieber anmelden</button>
